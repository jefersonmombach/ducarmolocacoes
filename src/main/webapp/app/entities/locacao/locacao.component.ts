...
export class LocacaoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.locacaoService
                ...
                .subscribe(
                    (res: HttpResponse<ILocacao[]>) => this.paginateLocacaos(res.body, res.headers),
    ...
    registerChangeInLocacaos() {
        this.eventSubscriber = this.eventManager.subscribe('locacaoListModification', response => this.reset());
    }
    ...
    printContrato(locacao: ILocacao) {
        this.locacaoService.printContrato(locacao);
    }
